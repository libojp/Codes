...
class c_weighMointor(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.weightMontr_thread.render(self.port_linkType, self.plc_rs485_port, self.plc_tcp_port, self.plc_tcp_stationNo)
...
class c_mointerThread(QtCore.QThread):
    ...
    def render(self, linkType, rs485_dict, tcp_addr, address=0x01):
        self.linkType = linkType
        self.port_RS485 = rs485_dict
        self.port_tcp = tcp_addr
        self.inAddress = address
